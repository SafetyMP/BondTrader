...
Examples:
  ...
  python regenerate_evaluation_dataset.py --scenarios normal_market,rate_shock_up_200bps
    ...
    parser.add_argument("--num-bonds", type=int, default=1000, help="Number of bonds to generate (default: 1000)")
    ...
    parser.add_argument("--backup", action="store_true", help="Backup existing dataset before regenerating")
    ...
    try:
        ...
        evaluation_dataset = evaluator.generate_or_load_evaluation_dataset(generate_new=True, num_bonds=args.num_bonds)
        ...
        if scenarios:
            ...
            evaluation_dataset = generator.generate_evaluation_dataset(
                num_bonds=args.num_bonds, scenarios=scenarios, include_benchmarks=True, point_in_time=True
            )
