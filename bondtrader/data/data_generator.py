...
class BondDataGenerator:
    ...
    def generate_bonds(self, num_bonds: int = 50) -> List[Bond]:
        ...
        # Issuer names
        issuers = [
            "US Treasury", "Corporate Tech Inc", "Global Finance Corp",
            "Municipal Authority", "Industrial Holdings", "Energy Solutions Ltd",
            "Telecom Global", "Healthcare Systems", "Manufacturing Co",
            "Investment Bank PLC", "Retail Chain Corp", "Transportation Ltd"
        ]
