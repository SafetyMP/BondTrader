...
class TrainingDataGenerator:
    ...
    def _generate_diverse_bond_universe(self, num_bonds: int) -> List[Bond]:
        ...
        ratings = ['AAA', 'AA+', 'AA', 'AA-', 'A+', 'A', 'A-',
                  ...
                  'B+', 'B', 'B-', 'CCC+', 'CCC', 'CCC-']
        rating_probs = [0.05, 0.05, 0.08, 0.07, 0.10, 0.12, 0.10,
    ...
    def _generate_stress_scenarios(self, bonds: List[Bond]) -> Dict:
        ...
        stress_scenarios['spread_widening'] = self._apply_stress_scenario(
            bonds, spread_change=0.01
        )
...
if __name__ == "__main__":
    ...
    print(f"Date range: {dataset['dataset_metadata']['date_range']['start']} to {dataset['dataset_metadata']['date_range']['end']}")
