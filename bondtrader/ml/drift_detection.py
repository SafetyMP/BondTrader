...
class BenchmarkGenerator:
    ...
    def generate_bloomberg_benchmark(self, bond: Bond) -> BenchmarkOutput:
        ...
        return BenchmarkOutput(
            bond_id=bond.bond_id, predicted_value=benchmark_value, confidence=confidence, methodology="bloomberg"
        )
    ...
    def generate_aladdin_benchmark(self, bond: Bond) -> BenchmarkOutput:
        ...
        return BenchmarkOutput(
            bond_id=bond.bond_id, predicted_value=benchmark_value, confidence=confidence, methodology="aladdin"
        )
    ...
    def generate_goldman_benchmark(self, bond: Bond) -> BenchmarkOutput:
        ...
        return BenchmarkOutput(
            bond_id=bond.bond_id, predicted_value=benchmark_value, confidence=confidence, methodology="goldman"
        )
    ...
    def generate_jpmorgan_benchmark(self, bond: Bond) -> BenchmarkOutput:
        ...
        return BenchmarkOutput(
            bond_id=bond.bond_id, predicted_value=benchmark_value, confidence=confidence, methodology="jpmorgan"
        )
    ...
    def generate_consensus_benchmark(self, bond: Bond) -> BenchmarkOutput:
        ...
        return BenchmarkOutput(
            bond_id=bond.bond_id, predicted_value=consensus_value, confidence=avg_confidence, methodology="consensus"
        )
    ...
    def _calculate_liquidity_adjustment(self, bond: Bond) -> float:
        ...
        rating_factor = {"AAA": 1.002, "AA": 1.001, "A": 1.000, "BBB": 0.999, "BB": 0.998, "B": 0.997, "CCC": 0.995}.get(
            bond.credit_rating[:3] if len(bond.credit_rating) >= 3 else "BBB", 0.999
        )
...
class DriftDetector:
    ...
    def calculate_drift(
        self, bonds: List[Bond], model_predictions: List[float], benchmark_methodology: str = "consensus"
    ) -> DriftMetrics:
        """
    ...
    def calculate_drift_by_regime(
        self, bonds: List[Bond], model_predictions: List[float], regimes: List[str], benchmark_methodology: str = "consensus"
