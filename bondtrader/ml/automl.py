...
class AutoMLBondAdjuster:
    ...
    def automated_model_selection(
        ...
        if 'random_forest' in candidate_models:
            ...
            rf_search = RandomizedSearchCV(rf_base, param_distributions, n_iter=25, cv=5, 
        ...
        if 'gradient_boosting' in candidate_models:
            ...
            gb_search = RandomizedSearchCV(gb_base, param_distributions, n_iter=25, cv=5,
                                          scoring='r2', n_jobs=-1, random_state=42)
        ...
        if 'neural_network' in candidate_models:
            ...
            nn_search = RandomizedSearchCV(nn_base, param_distributions, n_iter=20, cv=5,
                                          scoring='r2', n_jobs=-1, random_state=42)
