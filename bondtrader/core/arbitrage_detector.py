...
class ArbitrageDetector:
        ...
        for bond in bonds:
            ...
            if abs(profit_pct) >= (self.min_profit_threshold * 100) and is_profitable_after_costs:
                ...
                opportunity = {
                    ...
                    'arbitrage_type': self._classify_arbitrage_type(bond, net_profit_pct if self.include_transaction_costs else profit_pct)
                }
    ...
    def calculate_portfolio_arbitrage(
        self,
        bonds: List[Bond],
        ...
        total_fair_value = sum(
            self.valuator.calculate_fair_value(b) * w 
