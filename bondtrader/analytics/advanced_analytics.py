...
class AdvancedAnalytics:
    ...
    def _fit_nelson_siegel(
        ...
        def nelson_siegel(params, t):
            ...
            return (beta0 + beta1 * ((1 - np.exp(-t_over_tau)) / t_over_tau) +
    ...
    def relative_value_analysis(
        ...
        duration_adjusted_yield = bond_ytm * (bond_duration / avg_benchmark_duration) if avg_benchmark_duration > 0 else bond_ytm
