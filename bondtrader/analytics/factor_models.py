...
class FactorModel:
    ...
    def risk_attribution(
        ...
        factor_risk_pct = [r / portfolio_variance * 100 if portfolio_variance > 0 else 0 
                          for r in factor_risks]
        ...
        return {
            ...
            'idiosyncratic_risk_pct': ((portfolio_variance - total_factor_risk) / portfolio_variance * 100) 
                                     if portfolio_variance > 0 else 0
        }
    
    def statistical_factors(
        self,
        bonds: List[Bond],
        return_data: Optional[np.ndarray] = None,
        num_factors: int = 3
    ) -> Dict:
        """
