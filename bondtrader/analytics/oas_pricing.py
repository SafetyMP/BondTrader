...
class OASPricer:
    ...
    def calculate_oas(
        ...
        try:
            oas = self._solve_oas(
                bond, price, volatility, call_exercise_price, put_exercise_price
            )
    ...
    def _solve_oas(
        ...
        def price_difference(oas):
            calculated_price = self._binomial_price(
                bond, oas, volatility, call_price, put_price
            )
    ...
    def calculate_option_value(
        ...
        oas_result = self.calculate_oas(
            bond, bond.current_price, volatility, call_price
        )
